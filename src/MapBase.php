...
abstract class MapBase implements MappingBaseInterface
{
    ...
    private const REGION = 'MY';

    private const LANGUAGE = 'ms';
    ...
    public function __construct(View $view, array $options = [])
    {
        ...
        if (!isset($options['key'])) {
            throw new MapArgumentException('Google maps API key is required.');
        }

        if (!isset($options['version'])) {
            throw new MapArgumentException('Google maps API version is required.');
        }

        if (!isset($options['region'])) {
            throw new MapArgumentException('Region is required.');
        }

        if (!in_array($options['region'], $this->regions)) {
            throw new MapArgumentException('Region is required in ISO 3166-1 code format.');
        }

        if (!isset($options['language']) || !in_array($options['language'], $this->languages)) {
            throw new MapArgumentException('Language is required.');
        }

        if (!in_array($options['language'], $this->languages)) {
            throw new MapArgumentException('Language is required in ISO 639-1 code format.');
        }
    ...
    {
        if (!is_bool($value)) {
            throw new MapArgumentException('Invalid map enabled setting.');
        }
    ...
    {
        if (!is_string($value)) {
            throw new MapArgumentException('Invalid Google Map\'s API key.');
        }
    ...
    public function setVersion($value)
    {
        if (!is_float($value) && !is_string($value)) {
            throw new MapArgumentException('Invalid Google Map\'s API version.');
        }
    ...
    {
        if (!is_string($value)) {
            throw new MapArgumentException('Invalid map region.');
        }
    ...
    {
        if (!is_string($value)) {
            throw new MapArgumentException('Invalid map language.');
        }
    ...
    {
        if (!is_bool($value)) {
            throw new MapArgumentException('Invalid map marker setting.');
        }
    ...
    {
        if (!is_bool($value)) {
            throw new MapArgumentException('Invalid map center setting.');
        }
    ...
    {
        if (!is_bool($value)) {
            throw new MapArgumentException('Invalid map locate setting.');
        }
    ...
    {
        if (!is_bool($value)) {
            throw new MapArgumentException('Invalid map ui setting.');
        }
    ...
    {
        if (!is_numeric($value)) {
            throw new MapArgumentException('Zoom level must be an integer.');
        }

        if ($value < 1 || $value > 20) {
            throw new MapArgumentException('A zoom level must be between 1 and 20.');
        }
    ...
    {
        if (!is_bool($value)) {
            throw new MapArgumentException('Mouse Wheel Zoom must be a boolean.');
        }
    ...
    {
        if (!is_bool($value)) {
            throw new MapArgumentException('Zoom control must be a boolean.');
        }
    ...
    {
        if (!is_bool($value)) {
            throw new MapArgumentException('Map type control must be a boolean.');
        }
    ...
    {
        if (!is_bool($value)) {
            throw new MapArgumentException('Scale control must be a boolean.');
        }
    ...
    {
        if (!is_bool($value)) {
            throw new MapArgumentException('Street view control must be a boolean.');
        }
    ...
    {
        if (!is_bool($value)) {
            throw new MapArgumentException('Rotate control must be a boolean.');
        }
    ...
    {
        if (!is_bool($value)) {
            throw new MapArgumentException('Fullscreen control must be a boolean.');
        }
    ...
    public function setType($value)
    {
        if (!in_array($value, $this->types)) {
            throw new MapArgumentException('Invalid map type.');
        }
    ...
    {
        if (!is_numeric($value)) {
            throw new MapArgumentException('Invalid map heading.');
        }
    ...
    {
        if (!is_numeric($value)) {
            throw new MapArgumentException('Invalid map tilt.');
        }
    ...
    {
        if (!is_string($value)) {
            throw new MapArgumentException('Invalid map marker icon.');
        }
    ...
    public function setAnimation($value)
    {
        if (!in_array($value, $this->animations)) {
            throw new MapArgumentException('Invalid map marker animation.');
        }
    ...
    public function setGestureHandling($value)
    {
        if (!in_array($value, $this->gestureHandlers)) {
            throw new MapArgumentException('Invalid map gesture handling.');
        }
    ...
    {
        if (!is_bool($value)) {
            throw new MapArgumentException('Invalid map cluster setting.');
        }
    ...
    {
        if (!is_string($value)) {
            throw new MapArgumentException('Invalid map clusters icon setting.');
        }
    ...
    {
        if (!is_int($value)) {
            throw new MapArgumentException('Invalid map clusters grid setting.');
        }
    ...
    public function setClustersZoom($value)
    {
        if (!is_integer($value) && !is_null($value)) {
            throw new MapArgumentException('Invalid map clusters zoom setting.');
        }
    ...
    {
        if (!is_bool($value)) {
            throw new MapArgumentException('Invalid map clusters center setting.');
        }
    ...
    {
        if (!is_integer($value)) {
            throw new MapArgumentException('Invalid map clusters size setting.');
        }
