...
namespace LaravelLib\Gmaps\Facades;

use LaravelLib\Gmaps\Map as GoogleMap;
use Illuminate\Support\Facades\Facade;

/**
 * @method static string render(int $item)
 * @method static Location location()
 * @method static Map map($latitude, $longitude, array $options = [])
 * @method static Map streetview($latitude, $longitude, $heading, $pitch, array $options = [])
 * @method static Map marker($latitude, $longitude, array $options = [])
 * @method static Map informationWindow($latitude, $longitude, $content = '', array $options = [])
 * @method static Map polyline(array $coordinates = [], array $options = [])
 * @method static Map polygon(array $coordinates = [], array $options = [])
 * @method static Map rectangle(array $coordinates = [], array $options = [])
 * @method static Map circle(array $coordinates = [], array $options = [])
